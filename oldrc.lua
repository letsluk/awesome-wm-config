...
--beautiful.init("/home/lukas/.config/awesome/themes/blackburn/theme.lua")
...
mysessionmenu = {
   {"lock screen", function() awesome.spawn("i3lock -t -u -i /home/lukas/pictures/lockscreen.png") end, icon="/usr/share/icons/Papirus-Dark/16x16/actions/gnome-lockscreen.svg"},
   {"logout", function() awesome.quit() end, icon="/usr/share/icons/Papirus/16x16/apps/xfsm-logout.svg"},
   {"reboot", function() awesome.spawn("shutdown -r 0") end, icon="/usr/share/icons/Papirus/16x16/apps/system-reboot.svg" },
   {"shutdown", function() awesome.spawn("shutdown -h 0") end, icon="/usr/share/icons/Papirus/16x16/apps/gnome-shutdown.svg" }
...
-------------------------------------------------------------
syswidget=wibox.widget.systray()
...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({"Initial-"..s.index}, s, awful.layout.layouts[1])
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey,  "Shift"  }, "Left",   function() prepend_tag_or_move() end ,
              {description = "view previous", group = "tag"}),
    awful.key({ modkey,  "Shift"  }, "Right",  function() add_or_move_tag() end ,
    ...
    awful.key({ "Control", "Mod1"}, "Print", function() awful.util.spawn("deepin-screenshot") end),
    ...
    awful.key({"Control", "Mod1"}, "l" , function() awful.spawn("i3lock -t -u -i /home/lukas/pictures/lockscreen.png") end),
    -- Prompt
    --awful.key({ modkey },            "r",     function () awful.screen.focused().mypromptbox:run() end,
     --         {description = "run prompt", group = "launcher"}),
    awful.key({ modkey }, 	       "r", 
    		function()
			awful.util.spawn_with_shell("dmenu_run -i -p Run: -nb black -nf white ") 
		end,
...
awful.util.spawn("/home/lukas/.config/awesome/autolock.sh")
awful.util.spawn("killall megasync")
...
awful.util.spawn_with_shell("redshift-gtk -l 52.4:13.5 -t 6500:4000")
